...
<div id="sharePostModal" class="modal" style="display:none; align-items:center; justify-content:center; background:rgba(0,0,0,0.5); z-index:2000;">
        <div class="modal-content card" style="max-width:440px; width:95%; padding:0; position:relative; overflow:hidden; border-radius:16px; max-height: 90vh; display: flex; flex-direction: column;">
            <div style="padding:1rem 1.25rem; border-bottom:1px solid var(--border-color); display:flex; justify-content:space-between; align-items:center;">
                <h3 style="margin:0; font-size:1rem; font-weight:700;">Send Post To...</h3>
                <button onclick="closeShareModal()" style="background:var(--bg-light); border:none; border-radius:50%; width:28px; height:28px; cursor:pointer; font-size:1rem; display:flex; align-items:center; justify-content:center;">&times;</button>
            </div>
            <div style="padding: 0.75rem 1rem; border-bottom: 1px solid var(--border-color); background: var(--bg-light);">
                <div style="position:relative;">
                    ...
                    <input type="text" id="share-search-input" placeholder="Search followers..." oninput="filterShareList()" style="width:100%; padding:0.55rem 0.8rem 0.55rem 2.2rem; border:1px solid var(--border-color); border-radius:20px; font-size:0.85rem; background:var(--bg-white); font-family:inherit; outline:none; transition:border-color 0.2s;" onfocus="this.style.borderColor='var(--primary-color)'" onblur="this.style.borderColor='var(--border-color)'">
                </div>
            </div>
            <div id="share-friends-list" style="padding:0; flex: 1; overflow-y:auto; -webkit-overflow-scrolling: touch;">
